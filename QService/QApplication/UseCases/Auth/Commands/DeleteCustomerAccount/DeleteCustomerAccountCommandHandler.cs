...
public class DeleteCustomerAccountCommandHandler: IRequestHandler<DeleteCustomerAccountCommand, bool>
{
    ...
    public DeleteCustomerAccountCommandHandler(ILogger<DeleteCustomerAccountCommandHandler> logger, IQueueApplicationDbContext dbContext, IHttpContextAccessor contextAccessor, IPublishEndpoint publishEndpoint)
    {
        _logger = logger;
