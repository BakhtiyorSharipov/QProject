...
public class ResendVerificationCommandHandler: IRequestHandler<ResendVerificationCodeCommand, bool>
{
    ...
    public ResendVerificationCommandHandler(ILogger<ResendVerificationCommandHandler> logger, IQueueApplicationDbContext dbContext, IPublishEndpoint publishEndpoint)
    {
        _logger = logger;
