...
public class GetCustomerProfileQueryHandler: IRequestHandler<GetCustomerProfileQuery, CustomerProfileResponse>
{
    ...
    public GetCustomerProfileQueryHandler(ILogger<GetCustomerProfileQueryHandler> logger, IQueueApplicationDbContext dbContext, IHttpContextAccessor contextAccessor)
    {
        _logger = logger;
